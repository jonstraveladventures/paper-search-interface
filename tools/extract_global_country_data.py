...
def display_top_countries(country_counts, top_n=50):
    ...
    print(f"\n🏆 TOP {top_n} COUNTRIES BY PAPER COUNT:")
    print("=" * 80)
...
def display_all_countries(country_counts):
    ...
    print(f"\n🌍 ALL COUNTRIES WITH PAPERS (2015-2024):")
    print("=" * 80)
...
def export_to_csv(country_counts, filename='global_country_papers_2015_2024.csv'):
...
def main():
    """Main function"""
    print("🌍 Extracting Global Country Data for AI Research (2015-2024)...")
